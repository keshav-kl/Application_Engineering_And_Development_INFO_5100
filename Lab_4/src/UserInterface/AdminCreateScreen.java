...
public class AdminCreateScreen extends javax.swing.JPanel {
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        if(!usernamePatternVerify())
        {
            JOptionPane.showMessageDialog(null,"Username should be in the format xxx_xxx@xxx.com");
            txtUser.setBorder(BorderFactory.createLineBorder(Color.RED));
            jLabel1.setForeground(Color.RED);
            return;
        }
        ...
        if(!passwordPatternVerify())
        {
            JOptionPane.showMessageDialog(null,"Password should contain 6 characters, a number, Uppercase Character, LowerCase Character and Special Characters like $,#,@,!");
    ...
    private boolean usernamePatternVerify()
    {
    ...
    private boolean passwordPatternVerify()
    {
